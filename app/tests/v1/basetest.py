...
class BaseTestCase(TestCase):
    ...
    def setUp(self):
        ...
        wrong_signup_data = {"first_name": "Eric",
                             ...
                             "username": "Muchogo2",
                             "password": "1000"}
        admin_signup_data = {"first_name": "Eric",
                             "last_name": "Muchogo",
                             "other_names": "Ndungu",
                             "phonenumber": "0725530122",
                             "email": "ericmuchogo@gmail.com",
                             ...
                             "password": "1000",
                             "isAdmin": True}
        login_data = {"username": "Muchogo", "password": "1000"}
        nonexisting_user = {"username": "James", "password": "1000"}
        wrong_login_data = {"username": "Muchogo", "password": "68990"}
        wrong_login_data_format = {
            "username_name": "Muchogo", "password": "1000"}
        ...
        self.new_meetups_data_with_wrong_format = json.dumps(
            new_meetups_data_with_wrong_format)
        self.new_meetups_data_nonexisting_user = json.dumps(
            new_meetups_data_nonexisting_user)
